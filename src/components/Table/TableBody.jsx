...
export default function TableBody({uuid, nome, codigo, tipo, estoque, preco, grupo, ativo, refresh}){
    ...
    return(
        <tr class="odd:bg-primary even:bg-details-white border-b border-details text-gray-800">
            ...
            <td class="px-6 py-4 text-center flex gap-x-2 justify-center">
                <button type='button' className="bg-secondary shadow-lg p-2 rounded-md text-center text-primary cursor-pointer transition-all hover:bg-secondary-dark">
