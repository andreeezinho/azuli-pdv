...
export default function TableItem({uuid, nome, codigo, tipo, quantidade, preco, total}){
    return(
        <tr class="odd:bg-primary even:bg-details-white border-b border-details text-gray-800">
            ...
            <td class="px-6 py-4 text-center">
                <button type='button' className="bg-red-400 shadow-lg p-2 rounded-md text-center text-primary cursor-pointer transition-all hover:bg-red-500">
